...
Un enumeratore **E** inizia con un nastro di input vuoto. Se l'enumeratore non si ferma, esso puo' stampare un elenco infinito di stringhe. Il linguaggio enumerato da E e' la collezione di tutte le stringhe che esso stampa. Inoltre, **E** potrebbe generare le stringhe del linguaggio in qualsiasi ordine, eventualmente anche con ripetizioni.