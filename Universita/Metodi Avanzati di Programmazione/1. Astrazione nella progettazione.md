...
tags:
  - map
---
- [x] [[Astrazione nella progettazione#^qwnlqw|Concetto di astrazione]]
...
___
- [x] [[Astrazione nella progettazione#^6poes9|Tipi di Astrazione]]
...
___
- [x] [[Astrazione nella progettazione#^85h06k|Astrazione funzionale]]
...
- [x] [[Astrazione nella progettazione#^qmeiar|Specifica sintattica dell'astrazione funzionale]]
...
- [x] [[Astrazione nella progettazione#^qmeiar|Specifica semantica dell'astrazione funzionale]]
...
- [x] [[Astrazione nella progettazione#^zflv3q|Astrazione Dati]]
...
Un principio rispettato dall'astrazione dati è l'**[[Tecniche di progettazione#information hiding|information hiding]]**, che suggerisce di:
...
La combinazione del principio dell'astrazione dati con la tecnica dell'**[[Tecniche di progettazione#Encapsulation|incapsulamento]]** suggerisce che:
...
- [x] [[Astrazione nella progettazione#^975654|Specifica assiomatica dell'astrazione dati]]
...
- [x] [[Astrazione nella progettazione#^vkpkw9|Specifica algebrica dell'astrazione dati]]
